with  cross_items as
 ...
 select
   this_year.channel "_col_1",
   this_year.i_brand_id "_col_2",
   this_year.i_class_id "_col_3",
   this_year.i_category_id "_col_4",
   this_year.sales "_col_5",
   this_year.number_sales "_col_6",
   this_year.channel "_col_7",
   this_year.i_brand_id "_col_8",
   this_year.i_class_id "_col_9",
   this_year.i_category_id "_col_10",
   this_year.sales "_col_11",
   this_year.number_sales "_col_12"
 from
